...
class Project(Base):
    ...
    status = Column(Enum('Not Started', 'In Progress', 'Completed', 'On Hold'), nullable=False)
    ...
    phases = relationship("Project_Phase", back_populates="project")
...
class Alert(Base):
    ...
    alert_source = Column(Enum('Project', 'Task', 'System'), nullable=False)
    project_id = Column(Integer, ForeignKey("Projects.project_id"))
